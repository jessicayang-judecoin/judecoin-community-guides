# Community Guide: Windows CLI Wallet Recovery

## 【Description】

This is a community guide for Judecoin Windows CLI wallet recovery.

This guide is intended to help users restore an existing Judecoin wallet on Windows using the 25-word seed phrase.

This guide is shared as a community operation reference in the Discussion section. It is not an official document yet, but I hope it can help new users and provide practical feedback for future documentation.

## 【English Version: Windows CLI Wallet Recovery Guide】
...
This guide is a community operation reference intended to help users restore a Judecoin CLI wallet on Windows.
